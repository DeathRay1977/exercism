...
defmodule TeenagerTest do
  ...
  test "stating something short and lower" do
    assert Teenager.hey("a") == "Whatever."
  end

  test "asking an empty question" do
    assert Teenager.hey("?") == "Sure."
  end

  test "exclaim nothing" do
    assert Teenager.hey("!") == "Whatever."
  end
